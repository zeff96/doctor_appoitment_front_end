...
const handlers = [
  ...
  rest.get('https://doctor-api-3dvk.onrender.com/doctors/:id', (req, res, ctx) => {
      return res(ctx.status(200), ctx.json({id:1, name: 'doc1', bio: 'doc from kenya'}))
  }),
  rest.post('https://doctor-api-3dvk.onrender.com/doctors', (req, res, ctx) => {
    const {name, bio, image} = req.body
    return(
      res(ctx.status(201), ctx.json({id:1 , name, bio, image}))
    )
  }),
