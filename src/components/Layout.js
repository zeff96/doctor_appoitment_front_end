...
const Layout = () => (
  <div className="container-fluid">
    <div className="row main-page">
      <div className="col-3 col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xm-6" style={{ height: '100vh' }}>
        <Navbar />
      ...
      <div className="col-9 col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-6 col-xm-6 mx-auto py-6" style={{ height: '100vh' }}>
        <Outlet />
      </div>
    </div>
  </div>
